...
// Copyright Tensori Ltd
    public class Importer {
        ...
        public Importer(params string[] packages) {
            foreach (var package in packages) { this.packages.Push(package); }
        ...
        private void Progress() {
            ...
            if (request.Status == StatusCode.Success) { Debug.Log("Tensori auto import | Installed: " + request.Result.packageId); } else if (request.Status >= StatusCode.Failure) { Debug.LogWarning("Tensori auto import | " + request.Error.message); }
